            ...
            <div class="grid grid-cols-1  gap-6 mb-6">
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                        <div class="bg-gray-100 p-4 rounded-l">
                            <h4 class="text-l font-bold mb-2">Masuk</h4>
                            <p><strong>{{$kehadiran->start_time}}</strong></p>
                        </div>
                        <div class="bg-gray-100 p-4 rounded-l">
                            <h4 class="text-l font-bold mb-2">Pulang</h4>
                ...
                <div>
                    ...
                    <form class="row g-3" wire:submit='store' enctype="multipart/form-data">
                        ...
                        <button type="button" onclick="tagLokasi()" class="px-4 py-2 bg-blue-500 text-white rounded">Tag
                            Lokasi</button>
                            @if ($insideRadius)
